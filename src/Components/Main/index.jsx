...
import img1 from "./Imagenes/carrousel1.png"
import img2 from "./Imagenes/carrousel2.png"
import img3 from "./Imagenes/carrousel3.png"
...
function Main() {
    ...
    return (<>
        ...
        <Carousel className='w-screen bg-gradient-to-r from-purple-500 to-indigo-500'>
            <img
                alt="..."
                src={img1}
            />
